...
namespace T3PR1
{
    public class Missatges
    {
        ...
        public const string OpcioUnMenuMissatge = "Iniciant la simulació... que comenci la màgia energètica!",
            OpcioDosValidMenuMissatge = "Aquí tens les teves simulacions. Atenció, podries acabar creant una nova central elèctrica! ",
            OpcioDosInvalidMenuMissatge = "Ah, vols veure el futur? Doncs encara no tenim ni un sol dada. Fes la primera simulació i comencem!",
